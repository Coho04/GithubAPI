...
public class GHPullRequest extends ClassBase {
    ...
    private GHMilestone milestone = null;
...
//    public GHBase base;
    ...
    public GHPullRequest(Github github, JSONObject jsonObject) {
        ...
        if (jsonObject.has("milestone") && !jsonObject.isNull("milestone")) {
            this.milestone = new GHMilestone(github, jsonObject.getJSONObject("milestone"));
        }
        ...
        if (jsonObject.has("assignee") && !jsonObject.isNull("assignee")) {
            this.assignee = new GHUser(github, jsonObject.getJSONObject("assignee"));
        }
